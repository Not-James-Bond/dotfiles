# Generated by Powerlevel10k configuration wizard on 2023-02-18 at 16:47 IST.
...
# lightest, 24h time, vertical separators, slanted heads, slanted tails, 2 lines,
...
() {
  ...
  typeset -g POWERLEVEL9K_LINUX_MANJARO_ICON=$'%B\uF303'
